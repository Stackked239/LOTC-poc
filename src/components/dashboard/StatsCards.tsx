...
import { Package, DollarSign, AlertTriangle, XCircle, ArrowUp, ArrowDown } from 'lucide-react'
...
export function StatsCards({
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      {stats.map((stat) => (
        <Card key={stat.title} className={stat.alert ? 'border-l-4 border-l-yellow-500' : ''}>
